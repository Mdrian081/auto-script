...
# domain random
#CDN="https://raw.githubusercontent.com/Mdrian081/auto-script/master/ssh"
cd /root
...
#install ssh ovpn
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen      Install Riyan SSH Websocket           $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/Mdrian081/auto-script/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen          Install Riyan XRAY              $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/Mdrian081/auto-script/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/Mdrian081/auto-script/master/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Mdrian081/auto-script/master/menu/versi  )
...
echo "---------------------------t.me/RiyanFF-----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
