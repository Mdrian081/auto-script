...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/Mdrian081/auto-script/master/udp-custom/openvpn/squid3.conf"
sed -i $MYIP2 /etc/squid/squid.conf

# // OpenVPN
sleep 1
echo "\e[1;32m Proses Download OpenVPN.. \e[0m"
wget https://raw.githubusercontent.com/Mdrian081/auto-script/master/udp-custom/openvpn/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
