...
clear
source /var/lib/ipvps.conf 2>/dev/null || true
if [[ "$IP" = "" ]]; then
...
echo -e "\\E[0;41;36m      Add Riyan Shadowsocks Account    \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
shadowsockslink2="ss://${shadowsocks_base64e}@${domain}:$tls?mode=gun&security=tls&type=grpc&serviceName=ss-grpc&sni=${BUG_HOST}#${user}"
...
echo -e "\\E[0;41;36m       Riyan Shadowsocks Account      \E[0m" | tee -a /etc/log-create-shadowsocks.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-shadowsocks.log
echo -e "Remarks        : ${user}" | tee -a /etc/log-create-shadowsocks.log
echo -e "Domain         : ${domain}" | tee -a /etc/log-create-shadowsocks.log
echo -e "Wildcard       : ${BUG_HOST}.${domain}" | tee -a /etc/log-create-shadowsocks.log
